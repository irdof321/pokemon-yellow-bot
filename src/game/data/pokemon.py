...
def read_u24(raw: List[int], sl: tuple[int, int]) -> int:
    """Helper for 3-byte EXP (stored hi..lo in memory order)."""
    b0, b1, b2 = raw[sl[0]:sl[1]]
...
class PartyPokemon(Pokemon):
    ...
    def nickname(self) -> str:
        ...
        raw = MemoryData.game.memory[nick_md.start_address:nick_md.end_address + 1]
