...
class EmulatorSession(PyBoy):
    ...
    def __init__(self, version: GameVersion, *, logger=_loguru_logger, save_state_path: str | None = None, window: str = "SDL2"):
        super().__init__(ROM_PATHS[version], window=window, log_level="INFO", sound_emulated=True)
