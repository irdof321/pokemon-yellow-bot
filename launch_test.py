...
from tests.test_pokemon import test_party_order_matches_menu_screenshot, test_battle_scene, test_pokemon_from_state_first_party_mon_is_squirtle_named_ABCDEFGHIJ, test_moves
...
def main():
    ...
    print("Running test_battle_scene...")
    test_battle_scene()
    print("✅ test_battle_scene passed")
